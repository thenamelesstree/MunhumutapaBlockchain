    ...
    accountDetailsModal.on("show.bs.modal", function(e) {
        ...
        if (NRS.accountInfo.errorCode && NRS.accountInfo.errorCode != 5) {
            ...
            if (NRS.accountInfo.errorCode && NRS.accountInfo.errorCode == 5) {
				...
				$("#account_balance_balance").html(NRS.formatAmount(new BigInteger(NRS.accountInfo.balanceMTA)) + " " + NRS.getActiveChainName());
				$("#account_balance_unconfirmed_balance").html(NRS.formatAmount(new BigInteger(NRS.accountInfo.unconfirmedBalanceMTA)) + " " + NRS.getActiveChainName());
