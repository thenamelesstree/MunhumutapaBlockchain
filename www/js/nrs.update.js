...
var NRS = (function(NRS, $) {
	var DOWNLOAD_REPOSITORY_URL = "https://sourceforge.net/projects/munhumutapa/files/";
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "munhumutapa-release-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "munhumutapa-release-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "munhumutapa-release-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "munhumutapa-release-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "munhumutapa-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "munhumutapa-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "munhumutapa-release-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "munhumutapa-release-", ext: "sh"}
	];
