...
var NRS = (function(NRS, $) {
    ...
    NRS.addTreeviewSidebarMenuItem = function(options) {
        ...
        menuHTML += '<a href="#" data-page="' + options["page"] + '">' + options["titleHTML"] + '<i class="far pull-right fa-arrow-circle-down" style="border-radius: 30px;-webkit-appearance: none;padding-top:5px"></i></a>';
    ...
    NRS.appendMenuItemToTSMenuItem = function(itemId, options) {
        ...
        menuHTML += '><i class="far fa-arrow-circle-right"></i> ';
    ...
    NRS.initHeader = function() {
        ...
        var eurChainId = NRS.findChainByName("MUTAPA");
        ...
        widgetVisibility($("#header_withdraw_mutapa"), { apis: [NRS.constants.REQUEST_TYPES.sendMoney] }, eurChainId);
    };
